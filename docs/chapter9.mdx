...
<ProtectedContent chapterId="chapter9">

# Chapter 9: Natural Language and Multimodal AI

<PersonalizedTooltip term="LLM">Large language models</PersonalizedTooltip> and <PersonalizedTooltip term="VLM">vision-language systems</PersonalizedTooltip> are transforming how robots understand instructions and reason about tasks. This chapter explores how natural language interfaces make robots more accessible and capable.
