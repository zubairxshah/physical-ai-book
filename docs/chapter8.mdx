...
<ProtectedContent chapterId="chapter8">

# Chapter 8: Learning and Adaptation

Physical AI systems must learn from experience and adapt to changing conditions. This chapter explores how robots acquire skills through <PersonalizedTooltip term="learning from demonstration">demonstration</PersonalizedTooltip>, <PersonalizedTooltip term="self-supervised learning">self-supervised learning</PersonalizedTooltip>, and continuous adaptation in deployment.
