...
<ProtectedContent chapterId="chapter7">

# Chapter 7: Perception in Humanoid Robots

<PersonalizedTooltip term="perception">Perception</PersonalizedTooltip> systems enable humanoid robots to sense and understand their environment. This chapter explores the visual, tactile, audio, and <PersonalizedTooltip term="multi-modal">multi-modal</PersonalizedTooltip> sensing capabilities that give robots situational awareness.
